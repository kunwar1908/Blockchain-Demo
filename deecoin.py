...
app = FastAPI()
templates = Jinja2Templates(directory="C:/Users/kunwa/Python/Codes/blockchain-demo-main/templates")
app.mount("/static", StaticFiles(directory="C:/Users/kunwa/Python/Codes/blockchain-demo-main/templates/css"), name="static")
